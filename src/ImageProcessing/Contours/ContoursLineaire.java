...
public class ContoursLineaire {
    ...
    public static int[][] gradientSobel(int[][] image, int dir){
        // TODO: implement this
        throw new UnsupportedOperationException("gradientSobel n'est pas encore implémenté.");
    }
    
    public static int[][] laplacien4(int[][] image){
        // TODO: implement this
        throw new UnsupportedOperationException("laplacien4 n'est pas encore implémenté.");
    }
    
    public static int[][] laplacien8(int[][] image){
        // TODO: implement this
        throw new UnsupportedOperationException("laplacien8 n'est pas encore implémenté.");
    }
}
